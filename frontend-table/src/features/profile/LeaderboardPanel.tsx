          ...
          {METRICS.map((m) => (
            <button
              ...
              className={cn(
                ...
                metric === m.id
                  ? "bg-gold/15 text-gold-lite shadow-[0_0_16px_rgba(245,197,24,0.15)]"
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  isMe
                    ? "border-gold/40 bg-gold/[0.06] shadow-[0_0_18px_rgba(245,197,24,0.1)]"
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <p className="truncate text-sm font-semibold text-foreground">
                    ...
                    {isMe && <span className="ml-2 text-[10px] uppercase tracking-widest text-gold-lite">You</span>}
                  </p>
                </div>
