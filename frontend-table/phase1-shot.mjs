...
const shots = [
  { url: "http://localhost:3300/proof?screen=table&mode=2d", file: `${OUT}/phase1-proof.png`, wait: 9000 },
  { url: "http://localhost:3300/table?demo=1", file: `${OUT}/phase1-live.png`, wait: 9000 },
];
